...
![Find the public example mission by name](images/octave_interactive/find_public.png)

Once you have found the correct Mission, click "View Mission".

![Click View Mission](images/octave_interactive/example_mission.png)
...
![Clone the mission](images/octave_interactive/clone_mission.png)

You will now see a cloned copy of the Mission in your Missions.

![The cloned copy](images/octave_interactive/cloned_copy.png)
...
![Track job progress](images/octave_interactive/track_job.png)
...
![Copy the password](images/octave_interactive/copy_password.png)

Now, click **Job In Progress** and then click the chain icon to open the tunnel URL.

![Click on the tunnel URL](images/octave_interactive/chain.png)
...
![Jupyter in Galileo](images/octave_interactive/jupyter.png)
...
![Stop the job](images/octave_interactive/stop_job.png)
...
![Download results](images/octave_interactive/download.png)
